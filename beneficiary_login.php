...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Beneficiary Login - Vaccine Registration System</title>
    <link rel="stylesheet" href="/css/nicepage.css" media="screen">
<link rel="stylesheet" href="/css/beneficiary_login.css" media="screen">
    ...
    <meta property="og:title" content="beneficiary_login">
            ...
            <div class="u-layout-row">
              ...
              <div class="u-align-left u-container-style u-layout-cell u-palette-1-base u-right-cell u-size-30 u-size-xs-60 u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  ...
                  <p class="u-text u-text-2">Use ​your registration ID and the valid Unique ID <br>(eg. 95410892-47d7-49ce-be6e-c0b6db24d5d7)<br>that you have received after the registration.<br>
                  </p>
                  <div class="u-form u-form-1">
                    <form action="/beneficiary_loginDetails.php" method="POST" style="padding: 10px;">
                      <div>
                        <input type="text" placeholder="Enter your registration ID" id="brid" name="brid" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
                      </div><br>
                      <div>
                        <input type="text" placeholder="Enter the valid unique ID" id="buid" name="buid" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
                      </div>
                  ...
                  <a href="/beneficiary_reg.php" class="u-border-2 u-border-white u-btn u-btn-rectangle u-button-style u-none u-btn-2">REGISTER</a>
                  <p class="u-text u-text-3">Not Registered?<br>
                  </p>
                </div>
              </div>
            </div>
