...
<html style="font-size: 16px;">
  <head>
    ...
    <title>Admin Login - Vaccine Registration System</title>
  ...
  <body class="u-body">   
    ...
    <section class="u-clearfix u-section-1" id="sec-5035">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        ...
        <form action="/admin_loginDetails.php" method="POST" style="padding: 10px;">
                      <div>
                        <input type="password" placeholder="Enter the password" id="adminpass" name="adminpass" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required">
                      </div>
